	...
	*/
	...
	private void loadImages(String imageLocation, int scale) {
		try{
			...
			g.drawImage(icon.getImage(),0,0,newWidth,newHeight,0,0,icon.getIconWidth(),icon.getIconWidth(),null);
		}catch(Exception e){
			e.printStackTrace();
		}
	...
	private void loadImages(String imageLocation, int w, int h) {
		try{
			...
			if(w<=0){
				 ...
				 * null
				 */
				g.drawImage(icon.getImage(),0,0,w,h,0,0,icon.getIconWidth(),icon.getIconWidth(),null);
			}
		}catch(Exception e){
