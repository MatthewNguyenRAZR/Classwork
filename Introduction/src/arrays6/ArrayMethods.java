...
public class ArrayMethods {
	//searchUnsorted and isSorted methods are completed
	//countDifferences and getStats methods are partially completed
	
	//variables that can be modified to test out methods
	
	//used for searchUnsorted method
	static int[] SearchArray = {1,2,3,4,5};
	static int IndexKey = 2;
	
	//used for isSorted method
	static int[] DescendingArray = {30,25,21,16,13,10,9,6,4,-1,-6};
	
	//used for getStats method
	static double[] getStatsArray = {5,3,6,8};
	
	//used for countDifferences method
	static int[] array1 = {1,2,3,4,5};
	static int[] array2 = {1,2,3,3,5};
    ...
    public static void main(String[] args) {
      ...
      * */
    	...
    	System.out.println(searchUnsorted(SearchArray, IndexKey));
    	
    	System.out.println(isSorted(DescendingArray));
    			
    	System.out.println(getStats(getStatsArray)[0]);
    	System.out.println(getStats(getStatsArray)[1]);
    	System.out.println(getStats(getStatsArray)[2]);
    	System.out.println(getStats(getStatsArray)[3]);
    	System.out.println(getStats(getStatsArray)[4]);
    	System.out.println(getStats(getStatsArray)[5]);
    	
    	System.out.println(countDifferences(array1,array2));
    }
    ...
    public static double[] getStats(double[] array){
         ...
         * */
         ...
         for(int index=1;index<array.length;index++){
        	 if(stats[1] < array[index]){	
				stats[1] = array[index];
        	 }
        	 if(stats[2] > array[index]){	
 				stats[2] = array[index];
         	 }
         }
         ...
         //index 3
         stats[3] = -1;
         //I AM UNSURE OF HOW TO FIND THE MEDIAN
         
         //index 4 and 5
         stats[4] = 0;
         stats[5] = 0;
         for(int index=0;index<array.length;index++){
        	 if(array[index] >= stats[0]){	
        		 stats[4]++;
        	 }
        	 if(array[index] < stats[0]){	
        		 stats[5]++;
